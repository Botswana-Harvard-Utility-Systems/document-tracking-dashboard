...
from ...model_wrappers import HardCopyDocumentModelWrapper


class HardCopyDocumentListBoardView(
        NavbarViewMixin, EdcBaseViewMixin, ListboardFilterViewMixin,
        SearchFormViewMixin, ListboardView):

    listboard_template = 'hard_copy_document_listboard_template'
    listboard_url = 'hard_copy_document_listboard_url'
    ...
    def get_queryset(self):
        ...
        criterion2 = Q(document_form='hard_copy')
