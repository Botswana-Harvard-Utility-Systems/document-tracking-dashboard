"""
Django settings for document_tracking_dashboard project.
...
SECRET_KEY = 's8*_wpr=n&yy^hla+gjnx!bv+^p(9t57=(-phd7hp8g(5x6$se'
...
ROOT_URLCONF = 'document_tracking_dashboard.urls'
...
WSGI_APPLICATION = 'document_tracking_dashboard.wsgi.application'
